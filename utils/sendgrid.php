<?php
    ...
    function recoverPasswordMail($sendTo, $name, $token) {
        $subject = "Email de recuperació de compte";
        $content = '<div><h2 style=\"text-align: justify;\"><strong>'.$name.', s\'ha sol·licitat la recuperació del teu compte</strong></h2><p style=\"text-align: justify;\">A continuació, trobaràs l\'enllaç que has de fer servir per recuperar el teu compte. Si no has sol·licitat la recuperació del teu compte ignora aquest missatge.<br/><a href=\"https://plugandwork.cat/recover/'.$token.'\">Enllaç de recuperació</a></p></div>';
        sendgridMail($sendTo, $subject, $content);
    }
?>